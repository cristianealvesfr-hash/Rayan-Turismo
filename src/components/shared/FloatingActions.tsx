...
export const FloatingActions = () => {
  ...
  useEffect(() => {
    // Show buttons after a slight delay to avoid initial page load clutter
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-center">
      <a 
        ...
        target="_blank" 
        rel="noreferrer"
        className="h-14 w-14 rounded-full flex items-center justify-center shadow-lg shadow-pink-500/30 transform transition-all duration-300 hover:scale-110 overflow-hidden"
      >
        <img src="/icon-instagram.png" alt="Instagram" className="w-full h-full object-cover" />
      </a>
      ...
      >
        <img src="/icon-whatsapp.png" alt="WhatsApp" className="w-full h-full object-cover" />
      </button>
    </div>
  );
};
